...
/**
 * Full-overlay confetti burst. Place inside a [Box] with [Modifier.fillMaxSize()].
 *
 * @param active  Show/hide the animation. When set back to false the composable stops drawing.
...
fun ConfettiOverlay(
    ...
    Canvas(modifier = modifier) {
        particles.forEach { p ->
            ...
            val angle = (p.rotation + elapsed * 360f) * PI.toFloat() / 180f
